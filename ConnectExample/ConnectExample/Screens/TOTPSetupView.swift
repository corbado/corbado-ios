...
struct TOTPSetupView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ScreenHeadline(title: "MFA Setup", accessibilityIdentifier: "totpSetupScreen.headline")
            ...
            if viewModel.isLoading {
                ...
                HStack {
                    ...
                    Text(details.sharedSecret)
                        ...
                        .accessibilityIdentifier("totpSetupScreen.setupKey")
                    Button {
                ...
                TextField("Enter 6-digit code", text: $viewModel.totpCode)
                    ...
                    .cornerRadius(8)
                    .accessibilityIdentifier("totpSetupScreen.totpCode")
                
                if viewModel.errorMessage != nil {
                    Text(viewModel.errorMessage!)
                        .foregroundColor(.red)
                        .padding()
                        .accessibilityIdentifier("totpSetupScreen.errorMessage")
                }
                
                PrimaryButton(label: "Complete", isLoading: viewModel.isLoading, accessibilityIdentifier: "totpSetupScreen.complete") {
