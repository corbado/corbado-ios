...
public struct ClientInformation: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public var nativeMeta: NativeMeta?

    public init(bluetoothAvailable: Bool? = nil, clientEnvHandle: String? = nil, visitorId: String? = nil, canUsePasskeys: Bool? = nil, isUserVerifyingPlatformAuthenticatorAvailable: Bool? = nil, isConditionalMediationAvailable: Bool? = nil, clientCapabilities: ClientCapabilities? = nil, javaScriptHighEntropy: JavaScriptHighEntropy? = nil, isNative: Bool? = nil, webdriver: Bool? = nil, privateMode: Bool? = nil, clientEnvHandleMeta: ClientStateMeta? = nil, nativeMeta: NativeMeta? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(nativeMeta, forKey: .nativeMeta)
    }
}
